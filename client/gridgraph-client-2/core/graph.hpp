...
public:
	...
	void init(std::string path) {
		...
		//char *buffer_meta = "from client: 0 4847571 68993773 2";
		//char * b = rdma_read_start("read", "15.15.15.6", "12345",buffer_meta);
		//printf("b is : %s \n", b);
		//char remotepath[256] =  "/home/wangjing/GridGraph/aaaGrid";
		char remotepath[256] =  "aaaGrid";
		strcat(remotepath, "/meta");
		printf("remotepath is : %s \n", remotepath);
		//char * c = rdma_read_start("read", "15.15.15.6", "12345", remotepath);printf("c is : %s \n", c);
		int a = rdma_writefile_start("write","15.15.15.6","meta");
		printf("c is : %d \n", a);
